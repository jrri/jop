...
public final class Frame {
     ...
     * requires that the "duration" argument reside in a scope that encloses the
     * scope of the "this" argument. This constructor requires that the
     * "handlers" argument reside in a scope that encloses the scope of the
     * "this" argument.
     * 
     */
	@Allocate({ Area.THIS })
