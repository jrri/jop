...
public abstract class Clock {
	 ...
	 *         context representing the clock resolution. The returned object is
	...
	/**
	 * Gets the resolution of the clock, the nominal interval between ticks. The
	 * return value shall be associated with this clock. All relative time
	 * differences measured by this clock are approximately an integeral
	 ...
	 * 
	 * @param dest
	 *            return the relative time value in dest. If dest is null, a
	 *            newly allocated RelativeTime object in the current execution
	 *            context is returned. The returned object is associated with
	 *            this clock.
	 * @return dest is set to values representing the resolution of this. The
	 ...
	 * infrastructure. The default real-time clock does drive events.
	 * 
