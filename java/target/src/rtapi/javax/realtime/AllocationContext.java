...
/**
 * All memory allocation takes places from within an allocation context. This
 * interface defines the operations available on all allocation contexts.
 * Allocation contexts are implemented by memory areas. The RTSJ enter method
 * cannot be called by the SCJ application and hence is omitted.
 * 
 * @version SCJ 0.93
 * @note How much is needed?
 */
@SCJAllowed
