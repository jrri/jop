...
public class RFactMission extends Mission{
	
	RFactMission single = this;
	...
	protected void initialize() {
		...
		StorageParameters tempStorage = new StorageParameters(1024, null);
		RFactHandler t = new RFactHandler(tempPrio, tempPeriod, tempStorage, 512);
