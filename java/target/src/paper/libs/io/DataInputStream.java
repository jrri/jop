 ...
 * <p>
 * DataInputStream is not necessarily safe for multi-threaded access.
...
//		return String.copyValueOf(buf, 0, offset);
	...
	public static final String readUTF(DataInput in) throws IOException {
		...
		ReadUtfHelper readUtfHelper = new ReadUtfHelper();
		readUtfHelper.in = in;
...
class ReadUtfHelper implements Runnable{
	...
	public void run() {
		...
		try {
			...
			/*
			 * The first two bytes of the stream are used to form the utflen
			 * value, which specifies the number of additional bytes to be read
			 */
			int utflen = in.readUnsignedShort();
