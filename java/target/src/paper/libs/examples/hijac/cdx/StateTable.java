...
public class StateTable {
	...
	final private SafeHashMap<CallSign, Vector3d> motionVectors;
	...
	// WCMEM = 4 + 6 + (6 + SafeHashMap size)
	public StateTable() {
		// motionVectors = new CHashMap(Constants.MAX_OF_PLANES);
		motionVectors = new SafeHashMap<CallSign, Vector3d>(Constants.MAX_OF_PLANES);
		initObjectPool();
	}
