...
public abstract class InterfaceI2C implements IMACProtocol {
	...
	public void transmitPacket(PacketCore packet) {
		...
		sliceDataIntoBytesAndInsertIntoFrame(frame, packet.readHeader());
		sliceDataIntoBytesAndInsertIntoFrame(frame, packet.readContent());
		...
		i2cPort.flushTXBuff();
		System.out.println(i2cPort.status);
		System.out.println(i2cPort.tx_occu & I2Cport.OCCU_WR);
