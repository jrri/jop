 ...
 * @since	1.5
 */
abstract class SafeAbstractStringBuilder implements Appendable, CharSequence {
    ...
    static final IllegalStateException charSizeExc;
    static final StringIndexOutOfBoundsException negValueExc;
    static final StringIndexOutOfBoundsException negRangeExc;
    
    static{
    	charSizeExc = new IllegalStateException("Internal character array size exceeded");
    	negValueExc = new StringIndexOutOfBoundsException("Value less than zero");
    	negRangeExc =  new StringIndexOutOfBoundsException("start > end");
    }

    /** 
     * This no-arg constructor is necessary for serialization of subclasses.
     */
    SafeAbstractStringBuilder() {
    }

    /** 
     * Creates an SafeAbstractStringBuilder of the specified capacity.
     */
    // WCMEM = 6 + capacity
    SafeAbstractStringBuilder(int capacity) {
...
//     * </ul>
//     * If the <code>minimumCapacity</code> argument is non-positive, this
...
//    }
     ...
     */
	public SafeAbstractStringBuilder append(Object obj) {
	...
	// BCMEM = 0
	// MOD
	public SafeAbstractStringBuilder append(String str) {
		if (str == null)
			str = "null";
...
//	}
	...
	public SafeAbstractStringBuilder append(CharSequence s, int start, int end) {
		...
		if ((start < 0) || (end < 0) || (start > end) || (end > s.length()))
			throw new IndexOutOfBoundsException("Negative argument, start bigger than end, or end bigger than lenght" );
		int len = end - start;
		if (len == 0)
			return this;
		int newCount = count + len;
...
//				expandCapacity(newCount);
	...
	// MOD
	// WCMEM = 212
	public SafeAbstractStringBuilder append(long l) {
		if (l == Long.MIN_VALUE) {
...
//    }
     ...
     */
	// MOD
	public SafeAbstractStringBuilder insert(int index, char str[], int offset,
			int len) {
