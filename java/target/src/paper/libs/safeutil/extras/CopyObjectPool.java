...
public class CopyObjectPool<E> {
	 ...
	 */
	protected CopyPoolObject[] objects;
	 ...
	 */
	public CopyObjectPool(CopyPoolObjectFactory factory) {
	 ...
	 *            elements are created
	 */
	public CopyObjectPool(int size, CopyPoolObjectFactory factory) {
		this.MAX_OBJECTS = size;
		this.factory = factory;
		objects = new CopyPoolObject[MAX_OBJECTS];
