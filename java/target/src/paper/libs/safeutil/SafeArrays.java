...
//  }else{
//  	int arrRef = Native.toInt(array);
//      int arrType = Native.rdMem(arrRef+GC.OFF_TYPE);
//      array = (Object[]) Native.toObject(GC.newArray(newLength, arrType));
//  }
//	
...
//        return copy;
     ...
     * @serial include
     */
    private static class ArrayList<E> extends SafeAbstractList<E>
	...
	public <T> T[] toArray(T[] a) {
	    int size = size();
	    if (a.length < size)
		return SafeArrays.copyOf(this.a, size,
    ...
    public static String deepToString(Object[] a) {
        ...
        deepToString(a, buf, new SafeHashSet());
        return buf.toString();
    }
