...
import libs.lang.UnsupportedOperationException;
...
public abstract class SafeAbstractMap<K,V> implements Map<K,V> {
	
	static final UnsupportedOperationException unsupOperationExc;
	static final CloneNotSupportedException cloneNotSupExc;
	
	static{
		unsupOperationExc = new UnsupportedOperationException();
		cloneNotSupExc = new CloneNotSupportedException("Object not cloneable");
	}
...
//    public void putAll(Map m) {
		...
		int pos = m.size();
		while (--pos >= 0) {
			Map.Entry<? extends K, ? extends V> entry = (Map.Entry) entries
					.next();
...
//            put(e.getKey(), e.getValue());
	 ...
	 * 
	 * <p>
	 * This implementation returns a set that subclasses {@link SafeAbstractSet}
	 * . The subclass's iterator method returns a "wrapper object" over this
	 * map's <tt>entrySet()</tt> iterator. The <tt>size</tt> method delegates to
	 * this map's <tt>size</tt> method and the <tt>contains</tt> method
	 * delegates to this map's <tt>containsKey</tt> method.
	 * 
	 * <p>
	...
	public Set<K> keySet() {
		...
		if (keySet == null) {
			...
			keySet = new SafeAbstractSet<K>() {
				...
				public int size() {
					return SafeAbstractMap.this.size();
				}

				public boolean contains(Object k) {
					return SafeAbstractMap.this.containsKey(k);
				}
			};
		}
	 ...
	 * {@link SafeAbstractCollection}. The subclass's iterator method returns a
	...
	public Collection<V> values() {
		if (values == null) {
			...
			values = new SafeAbstractCollection<V>() {
				...
				public boolean contains(Object v) {
					return SafeAbstractMap.this.containsValue(v);
				}
			};
		}
		return values;
...
//    }
	...
	public static class SimpleEntry<K, V> implements Entry<K, V>,
		...
		public boolean equals(Object o) {
			...
			boolean a = e.getKey() == null ? key == null : e.getKey() == key;
			boolean b = e.getValue() == null ? value == null : e.getValue() == value;
...
//			return eq(key, e.getKey()) && eq(value, e.getValue());
	...
	public static class SimpleImmutableEntry<K, V> implements Entry<K, V>,
		...
		public boolean equals(Object o) {
			...
			boolean a = e.getKey() == null ? key == null : e.getKey().equals(
					key);
			boolean b = e.getValue() == null ? value == null : e.getValue()
					.equals(value);
